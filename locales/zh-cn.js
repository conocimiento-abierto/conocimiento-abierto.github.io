// Textos del decálogo en 简体中文. SPDX-License-Identifier: CC0-1.0
...
window.DECALOGO_TEXTOS["zh-cn"] = {
  ...
  "mainTitle": "开放知识十项原则",
  "items": [
    "<strong>普遍获取</strong>：人人都应当能够获取信息、知识以及教育软件。开放知识应当对所有人可及，不因社会经济背景、地理位置、性别或身体能力而有差别。这包括使用标准且开放的格式，以及开源软件，以确保在不同平台、设备和操作系统之间的互操作性与可移植性。",
    ...
    "<strong>多样性与情境化</strong>：开放知识资源应当适用于不同的情境与文化。教育应当适应本地需求，并反映我们所处世界的多样性。",
    "<strong>协作与社区</strong>：开放知识的生成是群体性的努力。应通过学习型社区促进协作与思想、资源的共享。",
    "<strong>可持续性</strong>：资源、平台与教育软件应当具备长期可持续性。这包括有效的资金模式、对技术基础设施与代码的维护，以及选择有利于项目延续的许可证，例如用于互惠的 AGPL v3，或便于机构采纳的 Apache 2.0。",
